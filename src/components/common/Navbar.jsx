...
import { setConnection, setAddress } from "../../redux/slice/userDetails";
      ...
      <div className="flex gap-10">
        ...
        <div className="text-gray-300 hidden md:flex items-center gap-5 font-bold text-base">
          <Link
            // to="/"
            className={`${
              isHome ? "text-[#00FFFF]" : "hover:text-[#00FFFF]"
          ...
          <Link
            to="/loop"
            className={`${
              isLoop ? "text-[#00FFFF]" : "hover:text-[#00FFFF]"
            } transition ease-in-out duration-300`}
          >
            Loop
          </Link>
